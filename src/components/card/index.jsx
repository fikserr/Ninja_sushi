...
function Card({ data }) {
  ...
  const {activeLike,basket} = useSelector((state) => state.basketData)
  ...
  const handleSetLike = (elId) => dispatch(setLike(elId));
  ...
  return (
    <div className={styles.card} >
      <div className={styles.card__images} onClick={()=>navigate(`detail/${data.id}`)}>
      ...
      <div className={styles.card__content}>
        ...
        <div className={styles.card__bottom}>
          ...
          <div>
            <button className={activeLike.some(item => item.id === data?.id && item.like) ? classNames(styles.card__bottom_like, styles.active) : styles.card__bottom_like} onClick={()=> handleSetLike(data)}>
                { activeLike.some(item => item.id === data?.id && item.like) ? 
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.799 5.4C11.8695 5.49398 11.9361 5.58783 11.999 5.68095C12.0619 5.58783 12.1285 5.49398 12.199 5.39999C13.0855 4.21802 14.6062 3 16.9991 3C19.3929 3 21.0765 4.22307 22.0475 5.86627C22.9932 7.46665 23.2696 9.45973 22.9855 11.1644C22.4237 14.5349 19.6333 17.2389 17.2243 19.023C15.9909 19.9364 14.7936 20.6551 13.9062 21.1452C13.4616 21.3907 13.0924 21.5801 12.8325 21.709C12.7024 21.7734 12.5996 21.8229 12.528 21.8567C12.4923 21.8736 12.4643 21.8866 12.4447 21.8957L12.4217 21.9063L12.4149 21.9094L12.4115 21.911L11.999 21C11.5865 21.9109 11.5855 21.9105 11.5852 21.9104L11.583 21.9094L11.5763 21.9063L11.5532 21.8957C11.5337 21.8866 11.5057 21.8736 11.4699 21.8567C11.3984 21.8229 11.2955 21.7734 11.1655 21.709C10.9056 21.5801 10.5364 21.3907 10.0918 21.1452C9.20437 20.6551 8.00712 19.9364 6.77376 19.023C4.36478 17.2389 1.57439 14.5349 1.01258 11.1644C0.728432 9.45975 1.00478 7.46667 1.95045 5.86628C2.92142 4.22307 4.60502 3.00001 6.99893 3C9.39184 2.99999 10.9125 4.218 11.799 5.4ZM11.999 21L11.5865 21.9109C11.8487 22.0297 12.1493 22.0297 12.4115 21.911C12.4112 21.9111 12.4115 21.911 11.999 21Z" fill="white"/>
              </svg>
                :
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button className={styles.card__bottom_firstplus} onClick={()=>handleCardData(data)}>
              ...
              <svg fill="#000000" width="24px"  viewBox="0 0 24 24" id="check" data-name="Flat Color" xmlns="http://www.w3.org/2000/svg" class="icon flat-color"><path id="primary" d="M10,18a1,1,0,0,1-.71-.29l-5-5a1,1,0,0,1,1.42-1.42L10,15.59l8.29-8.3a1,1,0,1,1,1.42,1.42l-9,9A1,1,0,0,1,10,18Z" ></path></svg>
                    :
